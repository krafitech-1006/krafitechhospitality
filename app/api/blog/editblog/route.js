...
import { Krafitechblog } from "@/_lib/model/blog/blog";
...
export async function POST(request) {
    try {
        ...
        const existingImage = await Krafitechblog.findById(_id);
        if (!existingImage) {
        ...
        if (file) {
            ...
            const result = await cloudinary.uploader.upload(dataURI, { folder: "Krafitech" });
