...
import { Krafitechjob } from "@/_lib/model/job/job"
...
export async function POST(request) {
    ...
    if (payload.operation === "addjob") {
        ...
        try {
            const fetchjob = await Krafitechjob.find({});
        ...
        try {
            ...
            const findbyidjob = await Krafitechjob.findById(_id);
        ...
        try {
            ...
            const findjobdetail = await Krafitechjob.findByIdAndUpdate(_id, {
                jobtitle: jobtitle,
                location: location,
                jobtype: jobtype,
                jobdescription: jobdescription,
        ...
        try {
            ...
            const deletejobdata = await Krafitechjob.findByIdAndDelete(_id);
