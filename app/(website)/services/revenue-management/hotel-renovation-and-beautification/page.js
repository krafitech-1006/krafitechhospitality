...
const HotelRenovationAndBeautification = () => {
  ...
  return (
    <div className='relative w-full bg-neutral-200 py-40 '>
      <div className='w-[90%] lg:w-[80%] m-auto '>
        ...
        <div className='w-full font-bold tracking-wider text-xl lg:text-4xl uppercase'>Hotel Renovation And Beautification</div>
        ...
        <div className='flex flex-col lg:flex-row justify-start items-start mt-4 lg:mt-8'>
          <div className='flex flex-col lg:flex-row'>
              ...
              <div className='rounded-lg bg-red-300 text-black p-2 w-full lg:w-[35rem] h-full lg:h-[15rem] tracking-wider'>
                Nowadays, hotel renovation is not only replacing worn out furniture and mattresses but much more the definition of competition in the hotel industry. A hotel needs to be up to standard, fresh and technologically aligned. You need to renovate because if you don’t your guests will fade away fast or will leave negative review which would have impact on prospect business. We have extensive experience in renovation, construction covering all civil work to cater all hotels requirement.
              </div>
           

            <div className=''>
              <img src={IMAGES.hotelrenovation} alt='hotelrenovation' className='w-[100%] h-[100%]' />
            </div>
          </div>
...
export default HotelRenovationAndBeautification
