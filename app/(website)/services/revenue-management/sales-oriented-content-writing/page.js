  ...
  return (
    <div className='relative w-full bg-neutral-200 py-40 '>
      <div className='w-[90%] lg:w-[80%] m-auto '>
        <div>
          <div className='font-bold tracking-wider text-4xl uppercase'>SALES ORIENTED CONTENT WRITING</div>
          {/* <div>
        ...
        <div className='flex flex-row justify-start items-center'>
          ...
          <div className='w-[50%] h-full justify-items-center'>
            <img src={IMAGES.SalesOriented} alt='SalesOriented' className='w-[70%] h-[70%]' />
          </div>
