      ...
      <div className='w-[90%] lg:w-[80%] m-auto '>
        ...
        <div className='flex flex-col lg:flex-row justify-start items-start mt-16'>
          <div className='flex flex-col gap-8'>
            <div className='font-bold tracking-wide text-2xl lg:text-7xl uppercase'>B2B Partnership</div>
            <div className='rounded-lg bg-red-300 text-black p-2 w-full lg:w-[35rem] tracking-wider'>
              We always focus on enlarging your hotel business to the next level. Our experienced staff will always do the Monetarized Automated SMS’s, After check-outs, providing links/SMS to every single guest to receive reviews and building up relations that will last forever-GUEST ENGAGEMENTS
            </div>
          </div>

          <div className=''>
            <img src={IMAGES.B2BPARTNERSHIP} alt='B2BPARTNERSHIP' className='' />
          </div>
