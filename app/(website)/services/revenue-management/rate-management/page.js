  ...
  return (
    <div className='relative w-full bg-neutral-200 py-40 '>
      <div className='w-[90%] lg:w-[80%] m-auto '>
        <div>
          <div className='font-bold tracking-wider text-4xl uppercase'>Rate Parity Management</div>
          {/* <div>
        ...
        <div className='rounded-lg bg-red-300 text-black p-2 w-[35rem] tracking-wider  ml-16'>
          <span className='font-semibold'>• Rate Parity Management Levers:</span>  In simple terms, a rate parity strategy involves maintaining consistent rates for the same product, across all online distribution channels, we believe it a basic but most important part of our commitment to our partners. KRAFITECH SOLUTIONS ensures that our partner hotels have a complete control of setting the bar for their room rates and ensure equal prices across all distribution channels. KRAFITECH SOLUTIONS safeguards our partner hotel’s brand value and online reputation by keeping an extra eye on rate parity management.
        </div>

        <div className='rounded-lg bg-red-300 text-black p-2 w-[35rem] tracking-wider  ml-16 mt-8'>
          <span className='font-semibold'>• Daily Review System: </span>  KRAFITECH SOLUTIONS maintains a daily rate review system for the partner hotels with the support of relevant technology. Our human supported system can find rate disparity among OTA partners and report them to concerned market managers and maintain a rate parity for our partner hotels and resorts.
        </div>
