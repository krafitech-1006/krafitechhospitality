  ...
  return (
    <div className='relative w-full h-full bg-neutral-200 py-40 '>
      <div className='w-[90%] lg:w-[80%] m-auto '>
        <div className='w-full font-bold tracking-wider text-4xl uppercase'>Hotel Operations</div>
        <div className='flex flex-row justify-start items-start mt-8'>
          <div className='flex flex-row'>
            <div className='rounded-lg bg-red-300 text-black p-2 w-[35rem] max-h-fit tracking-wider'>
