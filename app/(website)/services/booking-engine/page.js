        ...
        <div className='relative w-full bg-neutral-200 py-40 '>
            <div className='w-[90%] lg:w-[80%] m-auto '>
                ...
                <div className='flex flex-col lg:flex-row justify-start items-start mt-8'>
                    <div>
                        <div className='font-bold tracking-wide text-2xl lg:text-7xl'>Booking Engine</div>
                        <div className='rounded-lg bg-yellow-200 text-black p-2 w-full lg:w-[35rem] tracking-wider mt-8'>
                    ...
                    <div className='w-full lg:w-[50%] h-full justify-items-center'>
                        <Image src={IMAGES.bookingengineimg} alt='bookingengineimg' height={1500} width={1500} className='w-full h-full lg:w-[80%] lg:h-[80%] object-scale-down' />
                    </div>
                </div>
                {/* <div className='font-bold tracking-widest text-black mb-5 text-lg'>PERFORMANCE REPORT</div> */}
                <div className='flex flex-col lg:flex-row justify-start items-start mt-8'>
                    <div className='mt-8'>
                        <div className='rounded-lg bg-yellow-200 text-black p-2 w-full lg:w-[35rem] tracking-wider'>
                    ...
                    <div className='w-full lg:w-[50%] h-full justify-items-center'>
                        <Image src={IMAGES.Bokingengin} alt='Bokingengin' height={1500} width={1500} className='w-full h-full lg:w-[80%] lg:h-[80%]' />
                    </div>
                </div>
                {/* <div className='mt-8'>
