...
const router = useRouter()
    ...
    const handleNavigation = (action) => {
      if (action === "back") {
        router.push('/services/web-development/websites-audit')
      }
  
    //   if (action === "next") {
    //     router.push('/services/web-development/ota-registration')
    //   }
    ...
    return (
        <div className='relative w-full bg-neutral-200 py-40 '>
            ...
            <div className='font-bold tracking-widest text-xl lg:text-4xl uppercase'>Hotel Website Development</div>
                <div className='flex flex-col lg:flex-row justify-start items-start mt-0'>
                    <div>
                        
                        <div className='rounded-lg bg-sky-600 text-black p-2 w-full lg:w-[35rem] tracking-wider mt-8'>
                    ...
                    <div className='w-full lg:w-[50%] h-full justify-items-center'>
                        <Image src={IMAGES.HotelwebsiteDevlopmentPage} alt='HotelwebsiteDevlopmentPage' height={1500} width={1500} className='w-full h-full lg:w-[80%] lg:h-[80%] object-scale-down' />
                    </div>
                </div>
                ...
                {/* <div className='flex flex-row justify-start items-start mt-8'>
                    <div className='rounded-lg bg-sky-600 text-black p-2 w-full lg:w-[35rem] tracking-wider'>
