        ...
        <div className='relative w-full bg-neutral-200 py-40 '>
            <div className='w-[90%] lg:w-[80%] m-auto '>
                ...
                <div className='flex flex-col lg:flex-row justify-start items-start mt-8'>
                    <div>
                        <div className='font-bold tracking-wide text-xl lg:text-6xl uppercase'>Web Designing</div>
                    ...
                    <div className='w-full lg:w-[50%] h-full justify-items-center'>
                        <Image src={IMAGES.webdesigningpage} alt='webdesigningpage' height={1500} width={1500} className='w-full h-full lg:w-[80%] lg:h-[80%] object-scale-down' />
                    </div>
                </div>
