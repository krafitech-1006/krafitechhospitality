...
const handleNavigation = (action) => {
  if (action === "back") {
    router.push('/services/digital-marketing/search-engine-optimization')
  }
    ...
    <div className='relative w-full bg-neutral-200 py-40 '>
      <div className='w-[90%] lg:w-[80%] m-auto '>
        ...
        <div className='flex flex-col lg:flex-row justify-start items-start mt-8'>
          <div>
          <div className='font-bold tracking-wide text-2xl lg:text-5xl uppercase'>Productive Email</div>
          ...
          <div className='w-full lg:w-[50%] justify-items-start'>
