                ...
                <div className="flex flex-col justify-center items-center w-full">
                    <div className="flex flex-col justify-center items-center w-full gap-6">
                        ...
                        <div className="font-normal text-md text-gray-600 text-center">
                            At Krafitech Hospitality, we believe in delivering more than just a service—we aim to build partnerships that help hotels thrive in the digital era. Here’s why hotels trust us to transform their online presence and achieve long-term success:
                        </div>
                    </div>
