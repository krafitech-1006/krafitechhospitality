                    ...
                    <div className="w-[90%] lg:w-[80%] m-auto">
                        <div className="mt-5 mb-4">
                            ...
                            <p className="text-base leading-relaxed">
                                {"Welcome to Krafitecha Hospitality. By accessing or using our services, you agree to be bound by these Terms and Conditions. These terms govern the relationship between Krafitecha Hospitality (“we,” “us,” or “our”) and you, the user or client (“you” or “your”), regarding our services, including but not limited to hotel listings on booking platforms, online visibility enhancements, and custom website development. If you do not agree to these terms, please refrain from using our services."}
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="w-[90%] lg:w-[80%] m-auto">
                        <div className="mt-5 mb-4">
                            ...
                            <ul style={{ listStyleType: 'disc', paddingLeft: '20px' }} className='flex flex-col gap-2 mt-4'>
                                <li>{`“Krafitecha Hospitality” refers to the business providing hospitality-related services, including online visibility solutions and website development.`}</li>
                                <li>{`“Client” refers to any individual, business, or organization engaging Krafitecha Hospitality’s services.`}</li>
                            ...
                            <div>
                                <div>
                                    ...
                                    <div>
                                        ...
                                        <ul style={{ listStyleType: 'disc', paddingLeft: '20px' }} className='flex flex-col gap-2 mt-2'>
                                            <li>{`Krafitecha Hospitality is not responsible for guest cancellations, refunds, or disputes arising on third-party booking platforms. These are subject to the terms and policies of the respective platforms.`}</li>
                        ...
                        <div className="mt-5 mb-4">
                            ...
                            <div>
                                ...
                                <ul style={{ listStyleType: 'disc', paddingLeft: '20px' }} className='flex flex-col gap-2 mt-2'>
                                    ...
                                    <li>{`Krafitecha Hospitality is not liable for any discrepancies or inaccuracies caused by incorrect information provided by the client.`}</li>
                                </ul>
                            </div>
                            ...
                            <div className='mt-3'>
                                ...
                                <p className='mt-2'>{`If the client fails to provide high-quality images for their hotel, Krafitecha Hospitality will not be liable for suboptimal results in visibility or engagement.`}</p>
                            </div>
                    ...
                    <div className="w-[90%] lg:w-[80%] m-auto">
                        <div className="mt-5 mb-4">
                            ...
                            <div>
                                ...
                                <ul style={{ listStyleType: 'disc', paddingLeft: '20px' }} className='flex flex-col gap-2 mt-2'>
                                    <li>{`Ownership of the custom website, including code and design, will be transferred to the client after full payment. Until then, Krafitecha Hospitality retains ownership rights.`}</li>
                                </ul>
                            </div>
                            ...
                            <div className='mt-3'>
                                ...
                                <ul style={{ listStyleType: 'disc', paddingLeft: '20px' }} className='flex flex-col gap-2 mt-2'>
                                    <li>{`The client grants Krafitecha Hospitality the right to use hotel-related content for the purpose of delivering services.`}</li>
                                </ul>
                            ...
                            <div className='mt-3'>
                                ...
                                <ul style={{ listStyleType: 'disc', paddingLeft: '20px' }} className='flex flex-col gap-2 mt-2'>
                                    <li>{`Krafitecha Hospitality reserves the right to showcase completed projects (e.g., websites) in our portfolio or marketing materials, unless expressly prohibited by the client.`}</li>
                                </ul>
                    ...
                    <div className="w-[90%] lg:w-[80%] m-auto">
                        <div className="mt-5 mb-4">
                            ...
                            <div>
                                ...
                                <ul style={{ listStyleType: 'disc', paddingLeft: '20px' }} className='flex flex-col gap-2 mt-2'>
                                    <li>{`“Krafitecha Hospitality is not responsible for losses resulting from:`}
                                        <ul style={{ listStyleType: 'disc', paddingLeft: '20px' }} className='flex flex-col gap-2 mt-2'>
                    ...
                    <div className="w-[90%] lg:w-[80%] m-auto">
                        <div className="mt-5 mb-4">
                            ...
                            <ul style={{ listStyleType: 'disc', paddingLeft: '20px' }} className='flex flex-col gap-2 mt-4'>
                                ...
                                <li>{`Krafitecha Hospitality will not share client data with third parties without explicit permission, except as required by law.`}</li>
                            </ul>
                        </div>
                    </div>
