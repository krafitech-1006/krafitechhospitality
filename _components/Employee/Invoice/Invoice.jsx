          ...
          <div className="card">
            <div className="header">
              <div className="logo-container">
                <img
                  src="http://localhost:3001/img/krafitechlogo.png"
                  className="logo"
                  alt="logo"
                />
              </div>
              <div className="contact-img-container">
                <img
                  src={`http://localhost:3001/img/krafitechcontact.jpg`}
                ...
                ? <div className="footer">
                  <div className="signature">
                    ...
                    <div className="signature-img-container">
                      <img
                        src={`http://localhost:3001/img/krafitechsign.png`}
          ...
          <div className="card">
            <div className="header">
              <div className="plogo-container">
                <img
                  src="http://localhost:3001/img/Krafitechlogo.jpg"
                  className="logo"
                  alt="logo"
                />
              </div>
            ...
            <div className="second-section">
              <div className="payment-details">
                <div className="subsection">
                  <h2 className="text-xs mb-1">Payment Details:</h2>
                  <p className="text-xs">Bank Transfer: Krafitech Hospitality Pvt Ltd.Bank</p>
