                    ...
                    <div className="flex flex-col md:flex-row justify-center items-center gap-10 md:gap-20 z-10 py-10 px-5 lg:pl-10">
                        ...
                        <div className="flex flex-col md:w-[45%] w-full gap-4 md:pl-10">
                            ...
                            <div className="text-gray-600 text-sm md:text-md font-semibold">
                                At Krafitecha, we are always seeking talented individuals who are driven, passionate, and eager to grow. Explore opportunities that match your skills and aspirations, and become part of a team that values innovation, collaboration, and excellence.
                            </div>
                            <div className="flex flex-col gap-2">
                                ...
                                <p className="text-gray-600 text-sm md:text-md font-semibold">
                                    {"We understand that talent comes in many forms, and even if there’s no exact match in our current openings, we’d love to hear from you! If you’re excited about joining Krafitecha and believe you can make a difference, please share your resume and a brief introduction about yourself at Krafitechahospitality@gmail.com. Let us know how you can contribute to our vision, and we’ll keep you in mind for future opportunities."}
                                </p>
                            </div>
                        </div>
