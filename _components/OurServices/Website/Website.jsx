...
const Website = () => {
    ...
    return (
        <div className='relative w-full bg-neutral-200 py-32 lg:py-40 '>
            <div className='w-[90%] lg:w-[80%] m-auto '>


                <div className='flex flex-col lg:flex-row justify-center items-start gap-8 mt-10'>
                    <div className='flex flex-col gap-8 w[50%]'>
                        <div className='font-bold tracking-wider text-2xl lg:text-6xl'>Web Development</div>
