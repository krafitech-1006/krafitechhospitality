...
const ContactForm = () => {
    ...
    return (
        <div className='w-full flex justify-center items-center p-4 mb-32'>
            <div className='flex flex-col md:flex-row w-full md:w-[82%] h-auto bg-gradient-to-r from-blue-400 via-blue-100 to-blue-200 rounded-2xl'>
                ...
                <div className='w-full md:w-[60%] px-4 md:px-8 py-8 md:py-16'>
                    <form className='flex flex-col gap-7' onSubmit={handleSubmit}>
                        ...
                        <div className='mt-4 text-gray-500 opacity-80 text-sm md:text-base'>
                            By submitting your details, you confirm that you would like to receive marketing emails from Krafitech hospitality and you agree to the storing and processing of your personal data by Krafitech hospitality as described in our privacy policy.
                        </div>
                        <button
                            type='submit'
