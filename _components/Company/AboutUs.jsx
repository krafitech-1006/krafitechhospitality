        ...
        <div className='w-full py-32'>
            <div className='w-[90%] lg:w-[80%] m-auto '>
                ...
                <div className='flex flex-row gap-0'>
                    <div className='flex flex-col gap-4 p-2 bg-[#c14ac178] rounded-xl mt-8 w-[40%] shadow-md'>
                        ...
                        <p>Krafitech Solutions plays a significant role in establishing your hotel as a brand.</p>
                    ...
                    <div className='w-[60%]'>
                        <Image src={IMAGES.webdevelopmentNew} alt='webdevelopmentNew' height={1500} width={1500} className='h-[70%] w-[80%] object-contain ml-8' />
                    </div>
                </div>
