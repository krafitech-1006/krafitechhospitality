                ...
                <div className='mt-10'>
                    ...
                    <div className="w-[90%] lg:w-[80%] m-auto">
                        <div className="mt-5 mb-4">
                            ...
                            <p className="text-base leading-relaxed">
                                {"At Krafitecha Hospitality, your privacy is of utmost importance to us. This Privacy Policy outlines how we collect, use, and protect your personal information when you engage with our services. By accessing or using our services, you agree to the terms of this Privacy Policy. If you do not agree, please refrain from using our services."}
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="w-[90%] lg:w-[80%] m-auto">
                        <div className="mt-5 mb-4">
                            ...
                            <p className="text-base leading-relaxed">
                                {"This Privacy Policy explains how Krafitecha Hospitality (“we,” “us,” or “our”) handles personal information that you provide to us through our website, services, or third-party platforms. This policy is applicable to users, clients, and visitors (“you” or “your”)."}
                            </p>
                        </div>
                    </div>
                        ...
                        <div className="mt-5 mb-4">
                            ...
                            <div className='mt-3'>
                                ...
                                <ul style={{ listStyleType: 'disc', paddingLeft: '20px' }} className='flex flex-col gap-2 mt-2'>
                                    ...
                                    <li>{`Protect the rights and safety of Krafitecha Hospitality or others.`}</li>
                                </ul>
                            </div>
                    ...
                    <div className="w-[90%] lg:w-[80%] m-auto">
                        <div className="mt-5 mb-4">
                            ...
                            <div>
                                ...
                                <p className='text-base leading-relaxed mt-2'>{`To exercise any of these rights, please contact us at support@Krafitecha.com.`}</p>
                            </div>
